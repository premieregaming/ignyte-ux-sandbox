...
export class ContentCreatorUX {
	...
	static content_creator_el: HTMLElement 
	static content_box_el: HTMLTextAreaElement
	static image_upload_dialog: HTMLElement
	static image_select_preview: HTMLImageElement
	static image_preview_container: HTMLElement
	static image_preview: HTMLImageElement
	...
	static init() {
		...
		let send_button: HTMLButtonElement = ContentCreatorUX.content_creator_el.querySelector('.button.content-send')
		send_button.onclick = ContentCreatorUX.on_click_send

		let img_button: HTMLButtonElement = ContentCreatorUX.content_creator_el.querySelector('.button[name="add-item"]')
		...
		let submit_button: HTMLButtonElement = ContentCreatorUX.image_upload_dialog.querySelector('.button.image-submit')
	...
	static close_dialog(event: Event) {
